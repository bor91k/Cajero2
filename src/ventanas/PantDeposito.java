 ...
 * @author Bor
 */
public class PantDeposito extends javax.swing.JFrame {
    
    PantMenu menu;

    public PantDeposito(PantMenu menu) {
        this.menu=menu;
        initComponents();
    ...
    private void initComponents() {
        ...
        lbMensaje.setText("Digite la cantidad a depositar, por favor");
    ...
    private void btEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntrarActionPerformed
        //clic en "entrar"
        System.out.println("Entrar - Deposito");//sacar
        ...
        if (Util.validarEfectivo(strEfectivo)){
            ...
            try{
                ...
                // ademas que sea multiplo de 20 y que lo que hay mas lo ingresado "rompa" el cajero
                //o sea: saldoUpdate tiene que ser como maximo el maximo stock del cajero

                //saldoUpdate tiene que ser como minimo >0 ya que se tiene que estar depositando algo coherente
                    
                /**/
                //porque no funciona este?????!! (sin invertir el IF)
                if (Cajero.esMultiploVeinte(doubEfectivo) && Util.noExcedeMaximo(efectivoAnterior,doubEfectivo) && Util.noExcedeMaximo(saldoAnterior,+doubEfectivo) ){
                
                //if ((efectivoAnterior+doubEfectivo<Double.MAX_VALUE) && (saldoAnterior+doubEfectivo<Double.MAX_VALUE) && Cajero.esMultiploVeinte(doubEfectivo) ){
                    
                    //los valores no "rompen" el sistema
                    double saldoUpdate = saldoAnterior+doubEfectivo;//se suma porque es un deposito
                    System.out.println( "saldoUpdate "+saldoUpdate);//sacar
                    
                    double efectivoUpdate = efectivoAnterior+doubEfectivo; //se suma porque es un deposito
                    ...
                    JOptionPane.showMessageDialog(null,"Deposito realizado con exito! \nIngresaste $"+doubEfectivo+"\nAhora hay $"+user.solicitarSaldo()+" en tu cuenta");
        ...
        System.out.println("fin enviar Deposito!");//sacar
